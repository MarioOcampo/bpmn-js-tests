...
import customElements from '../resources/custom-elements.json';
...
var bpmnModeler = new CustomModeler({ // Changed the modeler used, prev BpmnModeler({
  container: '#js-canvas',
  propertiesPanel: {
...
async function openDiagram(xml, customElements) {
...
$(function() {
  ...
  var exportArtifacts = debounce(async function() {
    ...
    // Custom elements create the error 
